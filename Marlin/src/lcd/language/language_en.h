...
namespace LanguageNarrow_en {
  ...
  LSTR MSG_SHAPING_Z_ENABLE               = _UxGT("Enable Z shaping");
  ...
  LSTR MSG_COLORS_RED                     = _UxGT("Red");                     // ProUI
  LSTR MSG_COLORS_GREEN                   = _UxGT("Green");                   // ProUI
  LSTR MSG_COLORS_BLUE                    = _UxGT("Blue");                    // ProUI
